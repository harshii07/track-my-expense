...
const API = axios.create({
  baseURL: 'https://track-my-expense-7cah.onrender.com/api',
});
...
export const verifyGooglePin = (data) => axios.post('https://track-my-expense-7cah.onrender.com/api/auth/google-verify-pin', data);